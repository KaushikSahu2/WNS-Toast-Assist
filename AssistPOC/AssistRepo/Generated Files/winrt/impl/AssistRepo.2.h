...
#pragma once
#ifndef WINRT_AssistRepo_2_H
#define WINRT_AssistRepo_2_H
#include "winrt/impl/Microsoft.UI.Xaml.1.h"
#include "winrt/impl/Microsoft.UI.Xaml.Markup.1.h"
#include "winrt/impl/AssistRepo.1.h"
WINRT_EXPORT namespace winrt::AssistRepo
{
    struct __declspec(empty_bases) MainWindow : winrt::AssistRepo::IMainWindow,
        ...
        impl::require<MainWindow, winrt::Microsoft::UI::Xaml::IWindow>
    {
        ...
        MainWindow(void* ptr, take_ownership_from_abi_t) noexcept : winrt::AssistRepo::IMainWindow(ptr, take_ownership_from_abi) {}
        MainWindow();
    };
