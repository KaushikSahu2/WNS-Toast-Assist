...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"AssistRepo.MainWindow"))
    {
        return winrt_make_AssistRepo_MainWindow();
    }

    if (requal(name, L"AssistRepo.XamlMetaDataProvider"))
    {
        return winrt_make_AssistRepo_XamlMetaDataProvider();
    }
