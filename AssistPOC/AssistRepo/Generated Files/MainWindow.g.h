...
namespace winrt::AssistRepo::implementation
{
    ...
    struct __declspec(empty_bases) MainWindow_base : implements<D, AssistRepo::MainWindow, composing, I...>,
        impl::require<D, winrt::Microsoft::UI::Xaml::IWindow>,
        impl::base<D, winrt::Microsoft::UI::Xaml::Window>
    {
        using base_type = MainWindow_base;
        using class_type = AssistRepo::MainWindow;
        ...
        {
            return L"AssistRepo.MainWindow";
        }
        MainWindow_base()
        {
...
namespace winrt::AssistRepo::factory_implementation
{
    ...
    {
        using instance_type = AssistRepo::MainWindow;
